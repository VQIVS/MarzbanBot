...
product_1 = types.InlineKeyboardButton(product_1_name.name, callback_data="product_1")
product_2 = types.InlineKeyboardButton(product_2_name.name, callback_data="product_2")
product_3 = types.InlineKeyboardButton(product_3_name.name, callback_data="product_3")
product_4 = types.InlineKeyboardButton(product_4_name.name, callback_data="product_4")
