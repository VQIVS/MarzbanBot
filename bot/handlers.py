...
from bot.keyboard import (
    ...
    Inline_payment_keyboard, Inline_cancel_keyboard
)
from django.db import IntegrityError
from datetime import datetime, timedelta, timezone
from .functions import create_user, get_access_token, generate_custom_id, get_user, delete_user
    ...
    for sub_user in sub_users:
        ...
        if user:
            ...
            formatted_message = (
                ...
                username, expire_date, days_to_expire, data_limit, status, used_traffic, subscription_url,
                subscription_url
            )
            ...
            if expire_date <= datetime.now() or data_limit - used_traffic <= 0:
                ...
                bot.send_message(user_id, "⚠️لطفا اشتراک خود را حذف و دوباره اقدام به خرید بفرمایید⚠️")
            else:
